define('coachingQuestionnaire/scripts/compiledTemplates/components/bloodpressure-question', ['ember'], function(Ember) { return Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
function program7(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n					</div>\n					<div class=\"systolicNotHigherErrorContainer\">\n						<span>");
  data.buffer.push(escapeExpression((helper = helpers.renderSafeString || (depth0 && depth0.renderSafeString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "bloodPressureIncorrect", options) : helperMissing.call(depth0, "renderSafeString", "bloodPressureIncorrect", options))));
