define('coachingQuestionnaire/scripts/compiledTemplates/components/multi-dropdown-question', ['ember'], function(Ember) { return Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  data.buffer.push(escapeExpression((helper = helpers['dropdown-input'] || (depth0 && depth0['dropdown-input']),options={hash:{
    'choices': ("firstChildQuestion.choices"),
    'inputLabel': ("firstChildQuestion.text"),
  ...
  data.buffer.push("\n					");
  data.buffer.push(escapeExpression((helper = helpers['dropdown-input'] || (depth0 && depth0['dropdown-input']),options={hash:{
    'choices': ("secondChildQuestion.choices"),
    'inputLabel': ("secondChildQuestion.text"),
