define('coachingQuestionnaire/scripts/compiledTemplates/components/dropdown-and-number-question', ['ember'], function(Ember) { return Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(escapeExpression((helper = helpers['dropdown-input'] || (depth0 && depth0['dropdown-input']),options={hash:{
    'choices': ("dropdownChildQuestion.choices"),
    'inputLabel': ("dropdownChildQuestion.text"),
    'value': ("dropdownValue")
  },hashTypes:{'choices': "ID",'inputLabel': "ID",'value': "ID"},hashContexts:{'choices': depth0,'inputLabel': depth0,'value': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "dropdown-input", options))));
  data.buffer.push("\n					");
  data.buffer.push(escapeExpression((helper = helpers['number-input'] || (depth0 && depth0['number-input']),options={hash:{
    'dataDefinitionName': ("numberChildQuestion.dataDefinitionName"),
    'initialValue': ("numberChildQuestion.answer"),
    'inputLabel': ("numberChildQuestion.inputLabel"),
    'value': ("numberInputValue")
  },hashTypes:{'dataDefinitionName': "ID",'initialValue': "ID",'inputLabel': "ID",'value': "ID"},hashContexts:{'dataDefinitionName': depth0,'initialValue': depth0,'inputLabel': depth0,'value': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "number-input", options))));
  data.buffer.push("\n				</div>\n				<div ");
