define('coachingQuestionnaire/scripts/compiledTemplates/components/radio-question', ['ember'], function(Ember) { return Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
function program3(depth0,data) {
  ...
  var buffer = '', helper, options;
  data.buffer.push("\n						<li>\n							<label ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "radioSelected", "", {hash:{
    'on': ("mouseUp")
  ...
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
    ...
    'id': ("value"),
    'value': ("value")
  },hashTypes:{'checked': "STRING",'name': "STRING",'id': "STRING",'value': "STRING"},hashContexts:{'checked': depth0,'name': depth0,'id': depth0,'value': depth0},contexts:[],types:[],data:data})));
  data.buffer.push("/>\n								");
  ...
  },hashTypes:{'active': "ID",'requiredButUnanswered': "ID",'submitButtonDomId': "ID",'backButtonDomId': "ID"},hashContexts:{'active': depth0,'requiredButUnanswered': depth0,'submitButtonDomId': depth0,'backButtonDomId': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "submit-button", options))));
