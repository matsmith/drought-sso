define('coachingQuestionnaire/scripts/compiledTemplates/components/open-text-question', ['ember'], function(Ember) { return Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  data.buffer.push(escapeExpression((helper = helpers['text-input'] || (depth0 && depth0['text-input']),options={hash:{
    'inputLabel': ("inputLabel"),
    'answer': ("answer"),
    'value': ("inputValue"),
    'dataDefinitionName': ("question.dataDefinitionName")
  },hashTypes:{'inputLabel': "ID",'answer': "ID",'value': "ID",'dataDefinitionName': "ID"},hashContexts:{'inputLabel': depth0,'answer': depth0,'value': depth0,'dataDefinitionName': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "text-input", options))));
